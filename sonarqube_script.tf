...
#!/bin/bash
  ...
  #Install New relic
  curl -Ls https://download.newrelic.com/install/newrelic-cli/scripts/install.sh | bash && sudo NEW_RELIC_API_KEY=NRJS-2903d038486c2a2784c NEW_RELIC_ACCOUNT_ID=3712463 NEW_RELIC_REGION=EU /usr/local/bin/newrelic install -y
